...
/// Widget tappable affichant une pièce de puzzle (polygone).
///
/// La pièce est dessinée par `PolygonPainter` qui s'adapte à la taille
/// disponible et centre le polygone dans son cadre.
